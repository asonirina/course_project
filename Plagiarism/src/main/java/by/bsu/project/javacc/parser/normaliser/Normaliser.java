...
package by.bsu.project.javacc.parser.normaliser;
...
//    }
  ...
  //  try {
      parser.ReInit(new FileInputStream(new File("D://test/Test.java")), new File("D://test/Out.java"));
      parser.Input();
    //}
//    catch (Exception e) {
...
StringBuffer modified = new StringBuffer();
    for (int i = 0; i < token.image.length(); i++) {
      if (token.image.charAt(i) != ' ' && token.image.charAt(i) != '\u005cn')
...
try {
  ...
  public Normaliser(InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Normaliser(InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public Normaliser(Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
