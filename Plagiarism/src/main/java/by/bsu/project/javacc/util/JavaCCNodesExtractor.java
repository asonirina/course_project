...
public class JavaCCNodesExtractor {
    public static List<String> getNodes(byte[] source, LangWrap.Lang lang) throws ParseException, UnsupportedLanguageException{
        JavaCCParser parser = createParser(new ByteArrayInputStream(source), lang);
        parser.Input();
        return parser.getNodes();
    }

    private static JavaCCParser createParser(InputStream in, LangWrap.Lang lang) throws UnsupportedLanguageException {
