...
public class JavaLexer extends Lexer {
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // Java.g:1008:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // Java.g:1008:13: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mFLOAT_TYPE_SUFFIX() throws RecognitionException {
        try {
            // Java.g:1027:19: ( ( 'f' | 'F' | 'd' | 'D' ) )
            // Java.g:1027:21: ( 'f' | 'F' | 'd' | 'D' )
            {
    ...
    public final void mESCAPE_SEQUENCE() throws RecognitionException {
        try {
            // Java.g:1039:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESCAPE | OCTAL_ESCAPE )
            int alt22=3;
    ...
    public final void mOCTAL_ESCAPE() throws RecognitionException {
        try {
            // Java.g:1046:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt23=3;
    ...
    public final void mUNICODE_ESCAPE() throws RecognitionException {
        try {
            // Java.g:1053:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            // Java.g:1053:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            {
            match('\\'); 
            match('u'); 
            mHEX_DIGIT(); 
    ...
    public final void mJAVA_ID_START() throws RecognitionException {
        try {
            // Java.g:1062:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // Java.g:
            {
    ...
    public final void mJAVA_ID_PART() throws RecognitionException {
        try {
            // Java.g:1079:5: ( JAVA_ID_START | '\\u0030' .. '\\u0039' )
            // Java.g:
            {
