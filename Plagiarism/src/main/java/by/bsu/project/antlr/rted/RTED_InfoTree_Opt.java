...
public class RTED_InfoTree_Opt {
    ...
    public static void main(String[] args) {
        ...
        TreeNode n2 = new TreeNode(1, "2", null, LangWrap.Operation.ARGUMENT);
        TreeNode n1 = new TreeNode(1, "2", n2, LangWrap.Operation.ARGUMENT);
        TreeNode n0 = new TreeNode(1, "1", n2, LangWrap.Operation.ARGUMENT);

        TreeNode n4 = new TreeNode(1, "1", null, LangWrap.Operation.FALSE);
        TreeNode n3 = new TreeNode(1, "1", n4, LangWrap.Operation.NAME);
        List<TreeNode> q1 = Arrays.asList(n0, n1, n2);
        List<TreeNode> q2 = Arrays.asList(n3, n4);
        RTED_InfoTree_Opt c = new RTED_InfoTree_Opt(1,1,1);
        c.init(q1,q2);
