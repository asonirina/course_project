        ...
        while (!treePairs.isEmpty()) {
            ...
            while ((row > firstRow) || (col > firstCol)) {
                ...
                if ((row > firstRow)
                    ...
                    editMapping.push(new int[]{node.getTokenIndex(), -1});
                    row--;
                    ...
                    editMapping.push(new int[]{ -1, node.getTokenIndex()});
                    col--;
                } else {
                    ...
                    if ((it1.getInfo(POST2_LLD, row - 1) == it1.getInfo(POST2_LLD, lastRow - 1))
                        ...
                        if (measure < 1) {
                            ...
                            editMapping.push(new int[]{node1.getTokenIndex(), node2.getTokenIndex()});
                        }
                        row--;
                        col--;
                    } else {
